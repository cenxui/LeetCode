...
public class Subsets {
	 ...
	 * 
	 * @param list
	 *            the list to store sublist
	 * @param index
	 *            current position in nums
	 * @param limit
	 *            the desire subset size must smaller than nums.length
	 * @param nums
	 *            the main set must larger than nums.length
	 * @param sublist
	 *            the subset of nums you can create new ArrayList or NULL
	 */

	private static void subset(List<List<Integer>> list, int index, int limit, int[] nums, List<Integer> sublist) {
